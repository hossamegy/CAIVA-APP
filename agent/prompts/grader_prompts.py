...
def get_grade_prompot():
    return PromptTemplate(
            ...
            3. 'book' — Use this tool when the question pertains to book-related inquiries or some specific domains.
            ...
            - If the question involves books, literature or some domains, return 'book'.
